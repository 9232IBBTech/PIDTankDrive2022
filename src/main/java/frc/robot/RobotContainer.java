...
import frc.robot.commands.PIDSmartPositionCommand;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    Constants.ControllerConstants.bButton.toggleWhenActive(new SequentialCommandGroup(new PIDSmartPositionCommand(pidSubsystem, 30), new PrintCommand("Tamam")));
