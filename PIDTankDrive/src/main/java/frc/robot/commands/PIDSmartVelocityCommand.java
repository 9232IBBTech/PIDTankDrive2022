...
public class PIDSmartVelocityCommand extends CommandBase {
  /** Creates a new PIDSmartVelocityCommand. */
  
  private PIDMotorSubsystem pidSubsystem;
  private double target;
  private double allowedErr;

  public PIDSmartVelocityCommand(PIDMotorSubsystem pidSubsystem, double target) {
  ...
  public PIDSmartVelocityCommand(PIDMotorSubsystem pidSubsystem, double target, double[] PIDF) {
    this.pidSubsystem = pidSubsystem;
    this.target = target;
    allowedErr = target * PIDConstants.ALLOWED_ERROR;
  ...
  public void initialize() {
    pidSubsystem.PIDSmartVelocity(target);
  }
