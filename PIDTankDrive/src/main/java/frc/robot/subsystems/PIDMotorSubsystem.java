...
public class PIDMotorSubsystem extends SubsystemBase {
  ...
  public PIDMotorSubsystem() {
    ...
    pidController.setP(0.0002, PIDConstants.DEFAULT_SMART_ID);
    pidController.setI(0.00000005, PIDConstants.DEFAULT_SMART_ID);
    pidController.setD(0.00003, PIDConstants.DEFAULT_SMART_ID);
    pidController.setFF(1/Constants.MotorConstants.NEO_MAX_VOLTAGE, PIDConstants.DEFAULT_SMART_ID);
    ...
    pidController.setFF(1/Constants.MotorConstants.NEO_MAX_VOLTAGE, PIDConstants.DEFAULT_PID_ID);
